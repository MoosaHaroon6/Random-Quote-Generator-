...
export default function Home() {
  ...
  return (
    <div className="flex w-full justify-center items-center mt-10 flex-col ">
      <Card className="w-[550px] gap-5 flex flex-col bg-slate-100 h-[600px]">
        <CardHeader>
          <CardTitle className="text-3xl text-center text-[#212121]">Random Quotes Generator</CardTitle>
        </CardHeader>
        <CardContent>
          <form>
            <div className="grid w-full items-center gap-4">
              <div className="flex flex-col space-y-1.5 gap-2">
                ...
                <p className="border h-[130px] flex items-center text-xl text-center">{quote}</p>
        ...
        <CardFooter className="flex justify-between">
          <Button
            variant="ghost"
            onClick={copyQuote}
            className="hover:bg-black hover:text-white w-[150px] border">Copy Quote</Button>
          <Button onClick={fetchQuote} className=" w-[150px]">Generate</Button>
        </CardFooter>
